          ...
          <Container className="mt-8 rounded-md bg-white shadow">
            ...
            <Section className="mx-auto w-full max-w-[90%]">
              ...
              <Text className="font-medium text-gray-500">
                ...
                changes have been made to your route offer on our platform. Here
                is a summary of the modifications:
              </Text>
            </Section>
            <Section className="mx-auto w-full max-w-[90%]">
              <Text className="text-primary mb-0 text-lg font-semibold">
              ...
              <Text className="m-0 font-medium text-gray-500">
                <b>Prefix:</b> {oldRoute.destination_code}
              </Text>
              <Text className="m-0 font-medium text-gray-500">
              ...
              <Text className="m-0 font-medium text-gray-500">
                <b>Prefix:</b> {newRoute.destination_code}
              </Text>
              <Text className="m-0 font-medium text-gray-500">
            ...
            <Section className="mx-auto w-full max-w-[90%]">
              <Text className="font-medium text-gray-500">
                These changes have been updated in our system. If you did not
                initiate these modifications or have any concerns, please
                contact our support team at lcrtelweb@gmail.com.
              </Text>
              <Text className="font-medium text-gray-500">
                Thank you for your continued partnership. We appreciate your
                dedication to providing quality route offers on our platform.
              </Text>
