...
const ManagerNav = ({
    ...
    return (
        <nav className="py-4 px-6 md:py-8 md:px-5 md:h-screen md:w-64 w-full fixed flex md:flex-col gap-2 items-center md:items-start justify-between  bg-surface">
            <button
                type="button"
