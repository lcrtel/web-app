...
const buttonVariants = cva(
    "inline-flex active:scale-[98%] transition-all ease-in-out items-center justify-center duration-150 rounded-full whitespace-nowrap text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-primary-950 dark:focus-visible:ring-primary-800 active:scale-[98%]",
    {
        variants: {
            variant: {
                default:
