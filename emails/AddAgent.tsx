...
export default function AddAgentMailTemplate({ user }: { user: any }) {
    return (
        <Tailwind
            config={{
                theme: {
        ...
        >
            <Html>
                ...
                <Preview>
                    Welcome to LCRTel.com - Account Details Inside
                </Preview>
                <Body className="bg-surface ">
                    <Container className="bg-white rounded-md shadow mt-8">
                        ...
                        <Section className="mx-auto w-full max-w-[90%]">
                            ...
                            <Text className="text-gray-500  font-medium ">
                                We're thrilled to have you onboard as part of
                                our esteemed team. Below, you'll find your
                                account credentials to access our platform:
                            </Text>
                        </Section>
                        <Section className="mx-auto w-full max-w-[90%]">
                        ...
                        <Section className="mx-auto w-full max-w-[90%]">
                            ...
                            <Text className="text-gray-500  font-medium ">
                                Thank you for choosing LCRTel.com! We're eager
                                to support your endeavors and contribute to your
                                success.
                            </Text>
