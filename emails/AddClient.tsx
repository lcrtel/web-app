...
export default function AddClientMailTemplate({ user }: { user: any }) {
    return (
        <Tailwind
            config={{
                theme: {
        ...
        >
            <Html>
                ...
                <Preview>
                    Welcome to LCRTel.com - Your Client Account is Ready!
                </Preview>
                <Body className="bg-surface ">
                    <Container className="bg-white rounded-md shadow mt-8">
                        ...
                        <Section className="mx-auto w-full max-w-[90%]">
                            ...
                            <Text className="text-gray-500  font-medium ">
                                We are delighted to welcome you as a new client
                                on LCRTel.com! Your account has been
                                successfully created, and we look forward to
                                providing you with a seamless experience on our
                                platform. Below are the details you'll need to
                        ...
                        <Section className="mx-auto w-full max-w-[90%]">
                            ...
                            <Text className="text-gray-500  font-medium ">
                                ...
                                business partner. We look forward to serving
