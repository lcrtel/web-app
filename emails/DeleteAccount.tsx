...
export default function DeleteAccount({ user }: { user: any }) {
    return (
        <Html>
            <Head>
                <title>LCRTel</title>
            ...
            <Preview>Account Deletion Notification</Preview>
            <Body className="bg-surface ">
                <Container className="bg-white rounded-md shadow mt-8">
                    ...
                    <Section className="mx-auto w-full max-w-[90%]">
                        ...
                        <Text className="text-gray-500  font-medium ">
                            We hope this message finds you well. We regret to
                            inform you that your account with LCRTel has been
                            deleted.
                        </Text>
                    </Section>
                    <Section className="mx-auto w-full max-w-[90%]">
