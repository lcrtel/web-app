...
export default function DeleteTargetEmail({ target, user }: { target: any; user: any }) {
    return (
        <Html>
            <Head>
                <title>LCRTel</title>
            ...
            <Preview>Confirmation: Your Buying Target Has Been Deleted</Preview>
                ...
                <Container className="bg-white rounded-md shadow mt-8">
                    ...
                    <Section className="mx-auto w-full max-w-[90%]">
                        <Text className="text-primary mt-6 font-bold tracking-tight text-xl">
                            Confirmation: Your Buying Target Has Been Deleted
                        </Text>
                        <Text className="text-gray-500  font-medium ">
                            Dear {user?.name} ({user?.company_name}),
                        </Text>
                        <Text className="text-gray-500  font-medium ">
                            We want to inform you that the buying target you
                            recently posted on our platform has been
                            successfully deleted. Below are the details of the
                            deleted buying target:
                        </Text>
                    </Section>
                    ...
                    <Section className="mx-auto w-full max-w-[90%]">
                        <Text className="text-gray-500  font-medium ">
                            If this deletion was intentional, we understand. If
                            you have changed your mind or if this was done in
                            error, feel free to repost your target at any time.
                        </Text>
                        <Text className="text-gray-500  font-medium ">
