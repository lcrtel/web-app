                ...
                <Body className="bg-surface ">
                    <Container className="bg-white rounded-md shadow mt-8">
                        ...
                        <Section className="mx-auto w-full max-w-[90%]">
                            ...
                            <Text className="text-gray-500  font-medium ">
                                We hope this email finds you well. This is to
                                inform you that your login credentials has been
                                updated by our administrator. Below are the
                            ...
                            {user?.password && (
                                <>
                                    ...
                                    <Text className="text-red-500  font-semibold m-0">
                                        Please note that the password provided
                                        is temporary. We recommend logging in
                                        with the temporary password and changing
                                        it immediately to enhance the security
                                        of your account. To update your
                                        password, follow this link after logging
                                        in:{" "}
                        ...
                        <Section className="mx-auto w-full max-w-[90%]">
                            ...
                            <Text className="text-gray-500  font-medium ">
                                ...
                                regarding this update, please don't hesitate to
                                contact our support team at lcrtelweb@gmail.com.
                                We are here to assist you.
                            </Text>
                            <Text className="text-gray-500 mb-0  font-medium ">
