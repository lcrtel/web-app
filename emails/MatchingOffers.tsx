                    ...
                    <Container className="bg-white rounded-md shadow mt-8">
                        ...
                        <Section className="mx-auto w-full max-w-[90%]">
                            <Text className="text-gray-500  font-medium ">
                                ...
                                file containing the details of all the potential
                                matches.
                            </Text>
                            <Text className="text-gray-500  font-medium ">
                            ...
                            <Text className="text-gray-500  font-medium ">
                                Our team ensures the authenticity of all
                                potential matches before sharing them with you,
                                so you can trust that the opportunities are
                                genuine.
                            </Text>
