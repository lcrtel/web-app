                    ...
                    <Container className="bg-white rounded-md shadow mt-8">
                        ...
                        <Section className="mx-auto w-full max-w-[90%]">
                            ...
                            <Text className="text-gray-500  font-medium ">
                                ...
                                purchasing needs. We're delighted to confirm
                                that your purchase request has been successfully
                                received. Please find the details of your
                                selected routes attached below:
                            </Text>
                        </Section>
                        <Section className="bg-white mx-auto w-full max-w-[90%]">
                            ...
                            <Text className="text-gray-500 font-medium m-0">
                                <b>Prefered payment method:</b> {request.payment_type}
                            </Text>
                            <Text className="text-gray-500 font-medium m-0">
                                <b>WhatsApp No:</b>{" "}
                                {request.whatsapp_no}
                        ...
                        <Section className="mx-auto w-full max-w-[90%]">
                            <Text className="text-gray-500  font-medium ">
                                ...
                                accuracy. If you have any questions or if there
                                are changes you'd like to make, please reach out
                                to our support team at lcrtel@gmail.com.
                            </Text>
                            <Text className="text-gray-500  font-medium ">
                                We appreciate your trust in LCRTel. Our team is
                                committed to providing you with excellent
