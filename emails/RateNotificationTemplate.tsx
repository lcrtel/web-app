...
export default function RateNotificationTemplate({ data }: { data: any }) {
    return (
        <Html>
            <Head>
                <title>LCRTel</title>
                        ...
                        <table className="w-full  text-primary ">
                            ...
                            <tbody className=" ">
                                <tr className="font-medium text-slate-500">
                                    ...
                                    <td className="py-2  rounded-md px-3 bg-slate-100">
                                        {data.body.rateConfig.old_rate}
                                    </td>
                                    <td className="py-2  rounded-md px-3 bg-slate-100">
                                        {data.body.rateConfig.new_rate}
                                    </td>
                                    <td className="py-2  rounded-md px-3 bg-slate-100">
                                        {data.body.rateConfig.applicable_from}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
