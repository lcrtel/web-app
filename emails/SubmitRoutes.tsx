            ...
            <Body className="bg-surface ">
                <Container className="bg-white rounded-md shadow mt-8">
                    ...
                    <Section className="mx-auto w-full max-w-[90%]">
                        ...
                        <Text className="text-gray-500  font-medium ">
                            We are thrilled to confirm that your recent routes
                            have been successfully submitted to our platform.
                            Our team is diligently reviewing your submitted
                            offers to ensure their accuracy and quality. Once
                            verified, your offers will become visible to
                            potential clients seeking routes that match your
                            criteria.
                        </Text>
                    </Section>
                    ...
                    <Section className="mx-auto w-full max-w-[90%]">
                        <Text className="text-gray-500  font-medium ">
                            ...
                            containing the details of all the route offers you
                            posted. You can download and keep it for your
                            records.
                        </Text>
                        <Text className="text-gray-500  font-medium ">
                            Please stay tuned for further notifications from us
                            regarding the verification and visibility status of
                            your routes. If they match the targets of our
                            clients, you will be notified accordingly.
                        </Text>
                        <Text className="text-gray-500  font-medium ">
                            If you have any questions or need assistance, feel
                            free to reach out to our support team. Thank you for
                            choosing our platform to connect with potential
