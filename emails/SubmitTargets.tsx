...
export default function SubmitTargets({
  ...
  return (
    <Html>
      ...
      <Preview>Confirmation: Your Buying Targets Have Been Posted</Preview>
      <Body className="bg-surface">
        <Container className="mt-8 rounded-md bg-white shadow">
          ...
          <Section className="mx-auto w-full max-w-[90%]">
            ...
            <Text className="font-medium text-gray-500">
              We are pleased to inform you that your recently posted targets
              have been successfully submitted to our platform. Your targets
              will now be visible to vendors who have posted routes that match
              your criteria. Our team will review your targets to ensure they
              accurately represent your requirements.
            </Text>
          </Section>
          <Section className="mx-auto w-full max-w-[90%] bg-white">
            <Text className="font-medium text-gray-500">
              Here are the details of your posted buying targets:
            </Text>
          ...
          <Section className="mx-auto w-full max-w-[90%]">
            <Text className="font-medium text-gray-500">
              ...
              the details of all the buying targets you posted. You can download
              and keep it for your records.
            </Text>
            <Text className="font-medium text-gray-500">
              Please keep an eye on your account for any notifications regarding
              potential matches with vendor offers. If your targets align with
              the routes of our vendors, you will be notified accordingly.
            </Text>
            <Text className="font-medium text-gray-500">
              Feel free to log in to your account to view the full list of your
              posted targets and manage your preferences. If you have any
              questions or need assistance, our support team is here to help.
            </Text>
            <Text className="font-medium text-gray-500">
              Thank you for using our platform to connect with potential vendors
              and find the best routes for your business needs.
            </Text>
