                ...
                <Container className="bg-white rounded-md shadow mt-8">
                    ...
                    <Section className="mx-auto w-full max-w-[90%]">
                        ...
                        <Text className="text-gray-500  font-medium ">
                            ...
                            posted targets have been successfully submitted to
                            our platform. Your targets will now be visible to
                            vendors who have posted routes that match your
                            criteria. Our team will review your targets to
                            ensure they accurately represent your requirements.
                        </Text>
                    </Section>
                    ...
                    <Section className="mx-auto w-full max-w-[90%]">
                        <Text className="text-gray-500  font-medium ">
                            ...
                            containing the details of all the buying targets you
                        ...
                        <Text className="text-gray-500  font-medium ">
                            ...
                            vendor offers. If your targets align with the routes
                            of our vendors, you will be notified accordingly.
                        </Text>
                        <Text className="text-gray-500  font-medium ">
